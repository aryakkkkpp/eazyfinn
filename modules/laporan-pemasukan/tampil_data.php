...
// jika file di include oleh file lain, tampilkan isi file
  ...
  <div class="container-fluid">
    <!-- judul halaman -->
    <h1 class="h4 mb-4 text-gray-800"><i class="fas fa-file-import fa-fw mr-2"></i>Laporan Pemasukan</h1>
    ...
    if (!isset($_POST['tampil'])) { ?>
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <!-- form filter data -->
          <form action="?module=laporan_pemasukan" method="post" class="needs-validation" novalidate>
            <div class="row">
              <div class="col-lg-2">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <select name="kategori" class="form-control chosen-select" autocomplete="off" required>
                    ...
                    <?php
                    // sql statement untuk menampilkan data dari tabel "tbl_kategori" berdasarkan tipe "pemasukan"
                    $query_kategori = mysqli_query($mysqli, "SELECT id_kategori, nama_kategori FROM tbl_kategori WHERE tipe='Pemasukan'")
    ...
    ?>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <div class="form-group pt-2">
                  ...
                  <a href="modules/laporan-pemasukan/cetak.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&kategori=<?php echo $id_kategori; ?>" target="_blank" class="btn btn-warning btn-block mt-4 mr-3">
      ...
      <?php
      // mengecek kategori pemasukan yang akan ditampilkan
      // jika filter data kategori pemasukan "Semua" yang dipilih
      if ($_POST['kategori'] == 'Semua') { ?>
        <!-- tampilkan laporan pemasukan per periode dengan semua kategori -->
        <div class="card shadow mb-4">
          <div class="card-body">
            <!-- judul laporan -->
            <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
              <i class="fas fa-file-alt mr-2"></i> Laporan Pemasukan Tanggal <strong><?php echo $tgl_awal; ?></strong> s.d. <strong><?php echo $tgl_akhir; ?></strong>
            </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody class="pre-scrollable">
                  ...
                  // sql statement untuk menampilkan data pemasukan dari tabel "tbl_transaksi" dan tabel "tbl_kategori" berdasarkan "tanggal"
                  $query = mysqli_query($mysqli, "SELECT a.tanggal, a.kategori, a.deskripsi, a.pemasukan, b.nama_kategori 
                                                  FROM tbl_transaksi as a INNER JOIN tbl_kategori as b ON a.kategori=b.id_kategori
                                                  WHERE a.pemasukan!='NULL' AND a.tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'
                  ...
                  <tr>
                    <td class="text-center font-weight-bold" colspan="4">Total Pemasukan</td>
      ...
      // jika filter data kategori pemasukan selain "Semua" yang dipilih
      elseif ($_POST['kategori'] != 'Semua') { ?>
        <!-- tampilkan laporan pemasukan per periode dan per kategori -->
        <div class="card shadow mb-4">
          <div class="card-body">
            <!-- judul laporan -->
            <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
              <i class="fas fa-file-alt mr-2"></i> Laporan Pemasukan <strong><?php echo $nama_kategori; ?></strong> Tanggal <strong><?php echo $tgl_awal; ?></strong> s.d. <strong><?php echo $tgl_akhir; ?></strong>
            </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody class="pre-scrollable">
                  ...
                  // sql statement untuk menampilkan data pemasukan dari tabel "tbl_transaksi" berdasarkan "kategori" dan "tanggal"
                  $query = mysqli_query($mysqli, "SELECT tanggal, deskripsi, pemasukan FROM tbl_transaksi
                                                  WHERE pemasukan!='NULL' AND kategori='$id_kategori' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'
                  ...
                  <!-- tampilkan data total -->
                  <tr>
                    <td class="text-center font-weight-bold" colspan="3">Total Pemasukan</td>
                    <td class="text-right font-weight-bold">Rp. <?php echo number_format($total_pemasukan, 0, '', '.'); ?></td>
                  </tr>
                </tbody>
              </table>
