...
// jika user sudah login, maka jalankan perintah untuk delete
  ...
  if (isset($_GET['id'])) {
    ...
    if (!empty($bukti_transaksi)) {
      ...
      $hapus_file = unlink("../../images/pemasukan/$bukti_transaksi");
    }
    ...
    if ($delete) {
      // alihkan ke halaman pemasukan dan tampilkan pesan berhasil hapus data
      header('location: ../../main.php?module=pemasukan&pesan=3');
    }
  }
}
