  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <!-- judul form -->
        <h6 class="m-0 font-weight-bold">Ubah Data Pemasukan</h6>
      </div>
      <div class="card-body">
        <!-- form ubah data -->
        <form action="modules/pemasukan/proses_ubah.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="form-group col-lg-6 pl-0">
            ...
            <div class="input-group">
              ...
              <input type="text" name="jumlah" class="form-control mask-money" autocomplete="off" value="<?php echo number_format($data['pemasukan'], 0, '', '.'); ?>" required>
          ...
          <div class="form-group col-lg-6 pt-3 pl-0">
            ...
            <div class="col-lg-6 border rounded my-4">
              ...
              // jika data "bukti_transaksi" ada di database
                ...
                <img id="preview-file" src="images/pemasukan/<?php echo $data['bukti_transaksi']; ?>" class="col foto-preview py-3" alt="Bukti Transaksi">
              <?php } ?>
            </div>
          ...
          <div class="form-group pt-3">
            ...
            <a href="?module=pemasukan" class="btn btn-secondary pl-4 pr-4">Batal</a>
          </div>
        </form>
      </div>
    </div>
